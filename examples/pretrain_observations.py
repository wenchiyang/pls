...
if __name__ == "__main__":
    ...
    # pre_train_gf(n_train=90, net_class=Observation_net, downsampling_size=8, epochs=50)
    pre_train_gf(n_train=1000, net_class=Observation_net_cnn, downsampling_size=8, epochs=1000)
    # main_cluster()
