...
ghost(0)::ghost(0,0);ghost(1)::ghost(0,1);ghost(2)::ghost(1,0);ghost(3)::ghost(1,1).

pacman(0)::pacman(0,0);pacman(1)::pacman(0,1);pacman(2)::pacman(1,0);pacman(3)::pacman(1,1).
