...
import torch as th
from dpl_policy.pacman.util import get_ground_wall
...
class Pacman_DPLRolloutBufferSamples(NamedTuple):
...
class Pacman_DPLRolloutBuffer(RolloutBuffer):
    def __init__(self, *args, **kwargs):
        self.ghosts_errors = None
        self.walls_errors = None
        super(Pacman_DPLRolloutBuffer, self).__init__(*args, **kwargs)
    ...
    def reset(self) -> None:
        ...
        super(Pacman_DPLRolloutBuffer, self).reset()
    ...
    def add(
        ...
        super(Pacman_DPLRolloutBuffer, self).add(
            obs, action, reward, episode_start, value, log_prob
        )

    def get(
        self, batch_size: Optional[int] = None
    ) -> Generator[Pacman_DPLRolloutBufferSamples, None, None]:
        assert self.full, ""
    ...
    def _get_samples(
    ...
    ) -> Pacman_DPLRolloutBufferSamples:
        data = (
        ...
        return Pacman_DPLRolloutBufferSamples(*tuple(map(self.to_torch, data)))
...
class Pacman_DPLPPO(PPO):
    def __init__(self, *args, **kwargs):
        ...
        buffer_cls = Pacman_DPLRolloutBuffer
    ...
    def _setup_model(self) -> None:
        super(Pacman_DPLPPO, self)._setup_model()
