...
from pls.dpl_policies.carracing.util import safe_max, safe_min
...
class Carracing_DPLPPO(PPO):
    ...
    def _setup_model(self) -> None:
        super(Carracing_DPLPPO, self)._setup_model()
    ...
    def train(self) -> None:
        ...
        for epoch in range(self.n_epochs):
            ...
            for rollout_data in self.rollout_buffer.get(self.batch_size):
                ...
                values, log_prob, entropy, policy_safeties = self.policy.evaluate_actions(rollout_data.observations, actions)
