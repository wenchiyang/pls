...
def main(csv_file, root_dir, model_folder, n_train, net_class, net_input_size, net_output_size, image_dim, downsampling_size, epochs, keys, use_agent_coord=True):
    use_cuda = False
    batch_size = 8
    save_freq = 50
    ...
    dataset_train = Custom_Dataset(csv_file, root_dir, image_dim, downsampling_size, train=True, n_train=n_train)
    dataset_test1 = Custom_Dataset(csv_file, root_dir, image_dim, downsampling_size, n_train=n_train, n_test=200)
    dataset_test2 = Custom_Dataset(csv_file, root_dir, image_dim, downsampling_size, n_train=0, n_test=200)
